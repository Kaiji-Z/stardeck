...
export const enWarCopy: WarCopy = {
  ...
  starfield: {
    ...
    hqPickerManualTitleLabel: 'Planet name (optional, defaults to folder name)',
    hqPickerBrowse: 'Browse…',
    hqPickerManualHint: 'Click "Browse" to pick a folder in Explorer — the dialog can create a "New folder" anywhere as a new planet; or type an existing path directly. Registered planets join the starfield and can be chosen as the execution planet when issuing commands.',
    hqPickerManualDone: '✓ Registered into the starfield',
