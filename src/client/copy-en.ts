...
export const enWarCopy: WarCopy = {
  ...
  commandBand: {
    ...
    planHint: 'The Staff Officer has submitted a task brief; signing off delegates it (runs unattended at night too)',
    planPeek: 'Brief text (read before signing off)',
  ...
  lifecycle: {
    ...
    planPending: 'Brief awaiting your signature',
  ...
  preflight: {
    hint: 'Will stall at brief sign-off — nobody signs at night',
    hintTalking: 'Answer the Staff Officer first, then sign the brief — both steps before it proceeds; unattended at night it stalls until morning',
    toDirect: 'Switch to direct order',
    title: 'Commands graded L1 wait for your brief sign-off before proceeding; at night nobody signs and they stall. You can switch to L0 direct release (staff publishes immediately), or keep waiting for your signature.',
  },
  onboard: {
  ...
  focusPage: {
    ...
    planPending: 'Drafting the brief — the Staff Officer is writing it; enter the task session to ask or add context.',
    planEnterSession: 'Enter task session',
    taskGhostPlanning: 'Brief awaiting your signature — click to read it',
    taskGhostApproved: 'Brief signed; the task is about to be released — click to read the brief',
...
export const enPlainCopy: WarCopy = {
  ...
  commandBand: {
    ...
    planHint: 'The Planning Agent has submitted a brief; sign off and it proceeds (runs at night too)',
    planPeek: 'Brief text (have a look before signing off)',
  ...
  preflight: {
    hint: 'Waits for your brief sign-off — stalls all night if nobody signs',
    hintTalking: 'The Planning Agent is waiting for your reply, and the brief needs your signature — both steps before it proceeds; left unattended overnight it stalls',
    toDirect: 'Switch to direct execution',
    title: 'Items marked L1 wait for your brief sign-off before proceeding; at night nobody signs and they stall. You can switch to direct execution (the Planning Agent publishes immediately), or keep waiting for your signature.',
  },
  onboard: {
  ...
  focusPage: {
    ...
    configRegrade: 'Regrade',
    planTitle: 'Final plan',
    planPending: 'Drafting the brief — the Planning Agent is writing it; enter the task session to ask or add context.',
    planEnterSession: 'Enter task session',
    taskGhostPlanning: 'Brief awaiting your signature — click to read it',
    taskGhostApproved: 'Brief signed; the task is about to be published — click to read the brief',
