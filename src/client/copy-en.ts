...
export const enWarCopy: WarCopy = {
  ...
  legend: {
    ...
    rows: [
      ['●', 'Status, four tiers: blue = machines working', 'dot-run'],
      ['●', 'amber = awaiting you', 'dot-wait'],
      ['●', 'green = well-ended (settled/read)', 'dot-done'],
      ['●', 'red = defeat (final failure/fuse blown)', 'dot-fail'],
      ...
      ['Breathing outline', 'Command being received by staff (~15 s), no action needed'],
      ['!! / ??', 'Command prefix markers: !! do it now (L0) · ?? plan first (L2)'],
      ['L0/L1/L2', 'Autonomy grades: direct / plan-approval / clarify'],
      ['Four-segment bar', 'Command→Task→Operation→Report lifecycle progress'],
      ['Quality, five tiers', 'Bounty complexity tiers (chip color varies)'],
      ['Yellow/Red wait', 'Inbox waits over 30 min turn yellow, over 2 h turn red; "longest wait" bolded'],
    ],
  },
...
export const enPlainCopy: WarCopy = {
  ...
  legend: {
    ...
    rows: [
      ['●', 'Status, four tiers: blue = machines working', 'dot-run'],
      ['●', 'amber = awaiting you', 'dot-wait'],
      ['●', 'green = done (read)', 'dot-done'],
      ['●', 'red = failed (final/fuse blown)', 'dot-fail'],
      ...
      ['Breathing outline', 'New command being received by the Planning Agent (~15 s), no action needed'],
      ['!! / ??', 'Command prefix markers: !! do it now (L0) · ?? plan first (L2)'],
      ['L0/L1/L2', 'Autonomy grades: direct / plan-approval / clarify'],
      ['Four-segment bar', 'Issue→Task→Run→Result progress'],
      ['Quality, five tiers', 'Task complexity tiers (chip color varies)'],
      ['Yellow/Red wait', 'Pending over 30 min turns yellow, over 2 h turns red; "longest wait" bolded'],
    ],
  },
