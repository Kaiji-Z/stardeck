...
export const enWarCopy: WarCopy = {
  head: {
    ...
    fleetPill: executor => `Fleet · ${executor} ⇄`,
  },
  loading: {
  ...
  taskCard: {
    ...
    handleReview: 'Review · Staff session',
    handleReviewTitle: 'Read the report here; approve or reject with your verdict delivered in the staff session',
...
export const enPlainCopy: WarCopy = {
  ...
  taskCard: {
    ...
    handleReview: 'Review · Planning Agent session',
    handleReviewTitle: 'Read the report here; approve or reject with your verdict delivered in the Planning Agent session',
  ...
  dock: {
    label: 'Workbench',
    titleLine: c => `Planner ${c.pending} · Executor ${c.waiting} · running ${c.active}${c.failed > 0 ? ` · failed ${c.failed}` : ''} — click to return to the Workbench`,
