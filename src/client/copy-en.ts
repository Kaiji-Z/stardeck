...
export const enWarCopy: WarCopy = {
  ...
  composer: {
    ...
    gradeL2: { name: '?? Plan first', hint: 'Submits a plan for approval before any work — for big moves' },
...
export const enPlainCopy: WarCopy = {
  ...
  composer: {
    ...
    gradeL2: { name: '?? Plan first', hint: 'Proposal first, your nod, then work — for big moves' },
